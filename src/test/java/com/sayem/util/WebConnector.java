    ...
    public WebConnector(){
        ...
        if (OR == null){
            try {
                ...
                // Initialize OR
                OR = new Properties();
                FileInputStream fs = new FileInputStream("src/test/java/com/sayem/config/OR.properties");
                ...
                fs = new FileInputStream("src/test/java/com/sayem/config/"+OR.getProperty("testEnv")+"_config.properties");
                CONFIG.load(fs);
